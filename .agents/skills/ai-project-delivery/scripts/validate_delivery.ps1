...
$required = [ordered]@{
    '00-Governance-Policy' = @('README.md', 'PROJECT_CHARTER.md', 'GOVERNANCE_AND_RACI.md', 'ENGINEERING_POLICY.md', 'SECURITY_AND_PRIVACY_STANDARD.md', 'HUMAN_AI_COLLABORATION_PROTOCOL.md', 'DOCUMENT_QUALITY_STANDARD.md', 'STANDARDS_ALIGNMENT_MATRIX.md')
